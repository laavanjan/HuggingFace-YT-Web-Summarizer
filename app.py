...
repo_id="mistralai/Mistral-Small-24B-Base-2501"
    ...
    if not hf_api_key or not generic_url.strip():
        ...
        try:
            with st.spinner("Waiting..."):
                ...
                llm=HuggingFaceEndpoint(repo_id=repo_id,max_length=150,temperature=0.7,token=hf_api_key,task="text-generation")
